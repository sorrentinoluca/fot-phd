...
- Inquadramento: `docs/fot_walkthrough_conversazione.md`, `docs/fot_walkthrough.html`, `docs/paper/FOT_TEP_EXPERIMENT_PLAN_BIGDATA2026.md`, `docs/lit_review/FOT_TEP_GAP_ANALYSIS_AND_RELATED_WORK.md`, `docs/archive/lit_review_2026-09/FOT_TEP_LITERATURE_REVIEW_BIGDATA2026.md`.
