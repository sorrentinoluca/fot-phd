...
«È davvero nuovo? Cosa posso rivendicare?» FOT_TEP_GAP_ANALYSIS_AND_RELATED_WORK.md + walkthrough v2 §14.4
...
| Letteratura: cosa posso rivendicare | walkthrough §14.2 + §14.5 + §14.6 | ~4,4k |
| Esiste già un lavoro su X? | walkthrough §14.1, filtrando | ~4,2k |
| Verificare un numero sugli artefatti | `AUDIT_GUIDE.md` §5–§13 | ~8,5k |
| Nuova fase / piano sperimentale | `docs/paper/FoT_TEP_Review_Piano_Sperimentale.md` §8–§11, §13 | ~26k |
| Come scrivere il paper | `docs/paper/FoT_TEP_paper_blueprint.html` | ~19k |
| Aggiungere paper al corpus | `docs/MAINTENANCE.md` §6 | ~1k |

Il walkthrough è `docs/fot_walkthrough_conversazione_v2.md` (~32k intero: non
aprirlo tutto); una versione riassuntiva è `docs/fot_walkthrough.html` .

## Come leggere in modo economico

- **§14.1** classifica 98 lavori con  incide sul disegno ·  condivide un asse ·
