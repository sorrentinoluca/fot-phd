# Specifica dei run fault di sviluppo — §6.2, revisione 2
...
**Revisione 2 tracciata, post-batch, 2026-09-13.** La revisione pre-esecuzione originale
resta intatta in `SPECIFICA_RUN_FAULT.md`, commit
`c02111d132f3cc1c047d5c4ed112398724138e3f`. Questa revisione non cambia catalogo,
indici, stream, onset, orizzonte, finestre o dati: identifica il binario strumentato
effettivamente usato e corregge il criterio documentale sull’hash MEX alla luce della
prova di equivalenza registrata in [MEX_RECORD.md](MEX_RECORD.md).
...
Nella campagna `fault_dev_001` il binario prescritto è il gemello strumentato
`temexd_fault_philox.mexmaca64`, SHA-256
`834e2361915249402a1ec9074a4be04f22a6404deb841e5134bf34347dfde544`. Il MEX base
del freeze resta `temexd_philox.mexmaca64`, SHA-256
`6ae7e7be5394773f1854f1c53eddbd778ad7557b61fb05a93b3edb0552b1d11e`. Sorgenti,
diff, compilazione e prove incrociate sono in [MEX_RECORD.md](MEX_RECORD.md).
...
**Criterio MEX della revisione 2.** `mex_sha256` dei manifest deve essere uguale
all’hash del MEX strumentato dichiarato in [MEX_RECORD.md](MEX_RECORD.md), cioè
`834e2361915249402a1ec9074a4be04f22a6404deb841e5134bf34347dfde544`. Non deve essere
uguale all’hash del diverso binario base del freeze. L’equivalenza con il MEX base
`6ae7…` è dimostrata separatamente mediante un Normal di Fase 02 e il run fault
F1/30000, confrontando membri ZIP, valori IEEE-754 e contatori Philox come descritto
nel record.
