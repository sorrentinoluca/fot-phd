...
nessuna promozione a cal_thr, FAR o test. Provenienza in `studio2/PROVENIENZA.md` §§4,9.
...
il CSV congelato; dettagli post-hoc e impronte sono registrati nella nuova §9.1.
