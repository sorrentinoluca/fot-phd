...
root=Path('/Users/luker/fot-tep-harness-0310-d03');out=Path(__file__).resolve().parent;base='e9b60c5db77edfd3c06a29857e6ba5f61ebe139a';acquisition='567881abf06572812c00ccc0ed817d169b68fee6'
...
paths=['studio2/fase03/harness/'+n for n in ['metric_adapter.py','metrics.py','test_metric_raccordo.py','runtime.py','gate_rules.py','test_c01_c03.py','test_d01_replay.py','test_d02_predecessors.py']]+['studio2/fase03/producer_probe.py','studio2/fase03/run_pilot.py']
