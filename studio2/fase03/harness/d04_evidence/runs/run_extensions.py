...
K=Path(__file__).resolve().parent;W=Path('/Users/luker/fot-tep-harness-0310-d04');E=Path('/Users/luker/fot-tep-riverifica-harness-23859a2-01a0a1ec/evidence');env=dict(os.environ,PYTHONDONTWRITEBYTECODE='1');py='/opt/anaconda3/bin/python3'
commands=[]
for label,scripts in [('w_original',['retry_proof_probes.py']),('y_original',['edge_probes.py']),('z_original',['chain_probes.py']),('literal',['extended_probes.py','additional_edges.py']),('x23_adapted',['additional_edges.py'])]:
