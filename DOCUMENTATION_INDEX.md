...
| [`studio2/fase03/fault_runs/`](studio2/fase03/fault_runs) | Fault development specification, plans, MATLAB launcher, tests and isolated smoke | Full 40-run batch executed in a separate window; handoff in `HANDOFF_BATCH.md` |
